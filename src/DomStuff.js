...
const DomStuff = (function () {
  ...
  function editTask(i) {
    myTasks.myTasksList[i].titleTask = document.getElementById(
      'form-title'
    ).value;
    myTasks.myTasksList[i].projectTask = document.getElementById(
      'form-project'
    ).value;
    myTasks.myTasksList[i].contentTask = document.getElementById(
      'form-content'
    ).value;
    myTasks.myTasksList[i].dateTask = document.getElementById(
      'form-date'
    ).value;
    myTasks.myTasksList[i].priorityTask = document.getElementById(
      'form-status'
    ).value;
    document.getElementById('add-Task').style.display = 'block';
    document.getElementById('edit-Task').style.display = 'none';
